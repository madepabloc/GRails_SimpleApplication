			...
			<ol class="property-list person">
				...
				<li class="fieldcontain">
					<span id="age-label" class="property-label"><g:message code="person.age.label" default="Age" /></span>
						...
						<span class="property-value" aria-labelledby="age-label"><g:fieldValue bean="${personInstance}" field="age"/> años</span>
					
				</li>
				</g:if>
			
				<g:if test="${personInstance?.totalAmount}">
				<li class="fieldcontain">
					<span id="totalAmount-label" class="property-label"><g:message code="person.totalAmount.label" default="Total Amount" /></span>
					
						<span class="property-value" aria-labelledby="totalAmount-label"><g:fieldValue bean="${personInstance}" field="totalAmount"/> €</span>
