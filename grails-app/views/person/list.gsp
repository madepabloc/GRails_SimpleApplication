...
<%--				<li><a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a></li>--%>
	...
	<%--				<g:message code="default.new.label" args="[entityName]" />--%>
				...
				<li>
					<g:link class="create" action="create" controller="transference">
	<%--				<g:message code="default.new.label" args="[entityName]" />--%>
						Ordenar Nueva Transferencia
					</g:link>
				</li>
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="totalAmount" title="${message(code: 'person.totalAmount.label', default: 'Total Amount')}" />
				...
				<g:each in="${personInstanceList}" status="i" var="personInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: personInstance, field: "totalAmount")}</td>
